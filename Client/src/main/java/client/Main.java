 ...
 * 
 */
@WebService(name = "Main", targetNamespace = "http://model/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface Main {
    ...
    @Action(input = "http://model/Main/decryptRequest", output = "http://model/Main/decryptResponse")
    ...
    @Action(input = "http://model/Main/encryptRequest", output = "http://model/Main/encryptResponse")
