 ...
 * 
 */
@WebServiceClient(name = "MainService", targetNamespace = "http://model/", wsdlLocation = "http://localhost:9000/operations?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAINSERVICE_QNAME = new QName("http://model/", "MainService");
    ...
    public Main getMainPort() {
        return super.getPort(new QName("http://model/", "MainPort"), Main.class);
    }
    ...
    public Main getMainPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://model/", "MainPort"), Main.class, features);
    }
