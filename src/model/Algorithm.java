...
public class Algorithm {
    ...
    /**
     * Class that represents single encryption/decryption operation
     */
    public class SingleOperation{
        ...
        public SingleOperation(String input, String key, String output, String type){
            this.input=input;
            this.key=key;
            this.output=output;
            this.type=type;
    ...
    /**
     * Field that contains history of operations
     */
    private HashMap<Integer, SingleOperation> operationHistory=new HashMap<>();

    /**
     * Getter method to obtain the history of operations
     * @return HashMap of performed operations
     */
    public HashMap<Integer, SingleOperation> getOperationHistory(){
    ...
    public final String encrypt(String data, String publicKey) throws AlgorithmException {
        try {
            ...
            operationHistory.put(operationHistory.size()+1,new SingleOperation(data,publicKey,resultText.toString(),"encrypt"));
    ...
    public final String decrypt(String data, String privateKey) throws AlgorithmException {
        try {
            ...
            operationHistory.put(operationHistory.size()+1,new SingleOperation(data,privateKey,resultText.toString(),"encrypt"));
            return resultText.toString();
